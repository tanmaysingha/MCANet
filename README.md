...
![cityscapes_val_set]([https://github.com/tanmaysingha/MCANet/blob/main/Figures/City_color_map.png](https://github.com/tanmaysingha/MCANet/blob/main/Figures/fig_cityscapes_color_map-eps-converted-to.pdf)?raw=true)
